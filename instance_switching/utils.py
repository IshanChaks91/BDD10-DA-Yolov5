...
def write_synth_img(img_name, output_location, image):
    cv2.imwrite(output_location + 'synth_images/' + img_name + '.jpg', image)

def make_label(file_name_str, train_img, bdd10k_category_list, img_width, img_height, output_location):
    strinG = ''
