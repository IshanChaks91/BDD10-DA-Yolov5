...
#SBATCH --output=yolov5_bdd10k_mosaicyolov5pytorch_my_mosaic_seed450_test11_v1.%j.out    # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error=yolov5_bdd10k_mosaicyolov5pytorch_my_mosaic_seed450_test11_v1.%j.err     # filename for STDERR hm  
