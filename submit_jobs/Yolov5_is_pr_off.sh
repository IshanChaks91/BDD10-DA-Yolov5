...
#SBATCH --output=yolov5_bdd10k_ISyolov5pytorch_no_mosaic_IS_allseeds_person_test23_v1.%j.out    # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error=yolov5_bdd10k_ISyolov5pytorch_no_mosaic_IS_allseeds_person_test23_v1.%j.err     # filename for STDERR hm  
