...
#SBATCH --output=yolov5_bdd10k_mosaicyolov5pytorch_nomosaic_my_mosaic_1000samples_batch64_train_test19_v1.%j.out    # filename for STDOUT (%N: nodename, %j: job-ID)
#SBATCH --error=yolov5_bdd10k_mosaicyolov5pytorch_nomosaic_my_mosaic_1000samples_batch64_train_test19_v1.%j.err     # filename for STDERR hm  
...
python3 ~/my_projects/BDD10k_Data_Augmentaion/BDD10-DA-Yolov5/yolov5/train.py --img 1280 --batch 64 --epochs 300 --seed 450 --patience 50 \
...
python3 ~/my_projects/BDD10k_Data_Augmentaion/BDD10-DA-Yolov5/yolov5/train.py --img 1280 --batch 64 --epochs 300 --seed 1550 --patience 50 \
	--hyp ~/my_projects/BDD10k_Data_Augmentaion/BDD10-DA-Yolov5/yolov5/data/hyps/hyp.scratch-low.yaml \
	--data /scratch/ichakr2s/yolov5pytorch_aug/mosaic_bdd10k/Mosaic_Aug/data.yaml \
	--weights yolov5s6.pt --cache
	
python3 ~/my_projects/BDD10k_Data_Augmentaion/BDD10-DA-Yolov5/yolov5/train.py --img 1280 --batch 64 --epochs 300 --seed 3000 --patience 50 \
	--hyp ~/my_projects/BDD10k_Data_Augmentaion/BDD10-DA-Yolov5/yolov5/data/hyps/hyp.scratch-low.yaml \
	--data /scratch/ichakr2s/yolov5pytorch_aug/mosaic_bdd10k/Mosaic_Aug/data.yaml \
	--weights yolov5s6.pt --cache
